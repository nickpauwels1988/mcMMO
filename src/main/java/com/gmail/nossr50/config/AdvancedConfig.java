    ...
    protected boolean validateKeys() {
        ...
        for (Salvage.Tier tier : salvageTierList) {
            ...
            if (tier != Salvage.Tier.EIGHT) {
                ...
                if (getArcaneSalvageExtractFullEnchantsChance(nextTier) > getArcaneSalvageExtractFullEnchantsChance(tier)) {
                    reason.add("Skills.Salvage.ArcaneSalvage.ExtractFullEnchant.Rank_" + nextTier.toNumerical() + " should be less than or equal to Skills.Salvage.ArcaneSalvage.ExtractFullEnchant.Rank_" + tier.toNumerical() + "!");
                }

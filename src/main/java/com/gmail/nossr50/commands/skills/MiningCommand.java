...
public class MiningCommand extends SkillCommand {
    ...
    protected void dataCalculations(Player player, float skillValue, boolean isLucky) {
        ...
        // DOUBLE DROPS
        if (canDoubleDrop) {
            String[] doubleDropStrings = calculateAbilityDisplayValues(skillValue, PassiveAbility.MINING_DOUBLE_DROPS, isLucky);
    ...
    protected void permissionsCheck(Player player) {
        ...
        canDoubleDrop = Permissions.passiveAbilityEnabled(player, PassiveAbility.MINING_DOUBLE_DROPS) && !skill.getDoubleDropsDisabled();

...
public class HerbalismCommand extends SkillCommand {
    ...
    protected void dataCalculations(Player player, float skillValue, boolean isLucky) {
        ...
        if (canGreenThumbBlocks || canGreenThumbPlants) {
            ...
            String[] greenThumbStrings = calculateAbilityDisplayValues(skillValue, SkillAbility.GREEN_THUMB, isLucky);
        ...
        // DOUBLE DROPS
        if (canDoubleDrop) {
            String[] doubleDropStrings = calculateAbilityDisplayValues(skillValue, SkillAbility.HERBALISM_DOUBLE_DROPS, isLucky);
        ...
        // HYLIAN LUCK
        if (hasHylianLuck) {
            String[] hylianLuckStrings = calculateAbilityDisplayValues(skillValue, SkillAbility.HYLIAN_LUCK, isLucky);
        ...
        // SHROOM THUMB
        if (canShroomThumb) {
            String[] shroomThumbStrings = calculateAbilityDisplayValues(skillValue, SkillAbility.SHROOM_THUMB, isLucky);
    ...
    protected void permissionsCheck(Player player) {
        hasHylianLuck = Permissions.skillAbilityEnabled(player, SkillAbility.HYLIAN_LUCK);
        ...
        canFarmersDiet = Permissions.skillAbilityEnabled(player, SkillAbility.FARMERS_DIET);
        canDoubleDrop = Permissions.skillAbilityEnabled(player, SkillAbility.HERBALISM_DOUBLE_DROPS) && !skill.getDoubleDropsDisabled();
        canShroomThumb = Permissions.skillAbilityEnabled(player, SkillAbility.SHROOM_THUMB);
    }
